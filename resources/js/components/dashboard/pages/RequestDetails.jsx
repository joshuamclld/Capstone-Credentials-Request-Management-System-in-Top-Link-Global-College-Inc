                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500"
                                        >
                                            {statusOptions.map((opt) => {
                                                const locked = !paymentPaid && paymentLockedStatuses.includes(opt);
                                                return (
                                                    <option key={opt} value={opt} disabled={locked}>
                                                        {opt}{locked ? ' (payment required)' : ''}
                                                    </option>
                                                );
                                            })}
                                        </select>
