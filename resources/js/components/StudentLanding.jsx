...
export default function StudentLanding({ student, onLogout, onNavigate, currentPath, initialAuthTab, onStudentLogin }) {
  ...
  return (
    <div className="font-body-md text-on-surface bg-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-24">
          <div className="text-center mb-16">
            <h2 className="font-headline-md text-3xl text-on-background mb-4">Why Create an Account?</h2>
            <p className="text-on-surface-variant max-w-xl mx-auto">Secure, verified access to manage your credential requests.</p>
          </div>
        ...
        <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-24 bg-surface-container-low rounded-3xl mx-4 md:mx-auto">
          <div className="text-center mb-16">
        ...
        <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pb-32 pt-24">
      ...
      <StudentMobileNav active={currentPath} student={student} onNavigate={onNavigate} onOpenAuth={openAuth} />
